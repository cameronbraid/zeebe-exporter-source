...
public final class KafkaJsonSourceIT {
  ...
  public @ClassRule static final RuleChain RULE_CHAIN =
  ...
  private static ZeebeBrokerContainer newZeebeContainer() {
    ...
    final MountableFile exporterConfig =
        MountableFile.forClasspathResource("kafka-json-exporter.yml", 0775);
  ...
  public static class RecordCollector implements RecordSourceConnector {
    List<Record<?>> records = new ArrayList<>();

    public void connectTo(RecordSource source) {
